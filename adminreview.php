...
?>
        ...
        <section class="statistics">
            ...
            <div class="table-user">
             ...
             <input type="submit" value="Get Results" name="getresult" style="    padding: 10px 20px;
    border: crimson;
    margin-bottom: 20px;
    color: white;
    background: crimson;">
  ...
  $queryorder="SELECT distinct ordertable.*,register.id,ordertable.status as orderstatus from tbmainorder , toollist , register, ordertable 
  ...
  while ($row =mysqli_fetch_array(  $resultorder)){
    ...
    if ($date1<= $datetime && $datetime <= $date2) {
...
$toolbyday=(int)$row['price']*(int)$row['days'];
    ...
    border-radius: 5px;">User Details</a></th>
             ...
             if ($orderstatus==0) {
                 ...
                 <tr>
                 <th colspan="8" style="background-color: crimson !important;
                     text-align: center;
    font-style: italic;">This Order have been Canceled by the customer</th>
             </tr>
                 <?php
             }
             ?>
